"""
Django settings for Betenda project.
...
WSGI_APPLICATION = 'Betenda.wsgi.application'
ASGI_APPLICATION = 'Betenda.asgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'Betenda.exceptions.betenda_exception_handler',
