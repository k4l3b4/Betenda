...
class UserProfile(models.Model):
    ...
    followers = models.ManyToManyField(
        "User", related_name="followers", verbose_name=_("Followers"), blank=True, symmetrical=False)
    following = models.ManyToManyField(
        "User", related_name="following", verbose_name=_("Following"), blank=True, symmetrical=False)
...
class FollowerRequest(models.Model):
    ...
    def __str__(self):
        return f"Follow request from {self.follower.user_name}({self.follower.first_name})"
